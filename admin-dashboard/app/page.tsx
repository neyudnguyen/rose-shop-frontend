    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-64 bg-white border-r border-gray-200 p-6">
        ...
        <nav className="space-y-2">
          <Link href="/" className="flex items-center gap-3 px-3 py-2 text-gray-900 bg-gray-100 rounded-md">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <Link href="/reports" className="p-4 border rounded-lg hover:bg-gray-50 text-center">
                  <FileText className="w-6 h-6 mx-auto mb-2 text-gray-600" />
                  <span className="text-sm">View Reports</span>
                </Link>
                <Link href="/users" className="p-4 border rounded-lg hover:bg-gray-50 text-center">
                  <Users className="w-6 h-6 mx-auto mb-2 text-gray-600" />
                  <span className="text-sm">Manage Users</span>
                </Link>
                <Link href="/statistics" className="p-4 border rounded-lg hover:bg-gray-50 text-center">
                  <BarChart3 className="w-6 h-6 mx-auto mb-2 text-gray-600" />
                  <span className="text-sm">View Stats</span>
                </Link>
                <Link href="/categories" className="p-4 border rounded-lg hover:bg-gray-50 text-center">
